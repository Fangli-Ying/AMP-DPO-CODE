...
import os
base_model_name_or_path = "ProtGPT2"
...
parser.add_argument("--model_path", type=str, default='saved_dir/function_0/prefix/', help="Model checkpoint")
args = parser.parse_args()

device = 'cpu'
task_name_list = ["function_0"]
